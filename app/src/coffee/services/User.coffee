angular.module("classe1914.service").factory("User", [
  ...
  '$location'
  '$rootScope'
      (api, settings, types, TimeoutStates, UserIndicators, Story, localStorageService, $http, $timeout, $location, $rootScope)->      new class User
...
#                      break
          ...
          updateCareer: (choice)=>
              ...
              if choice?
                  state = choice
                  console.log("T'as fais le choix n°"+choice.choice)
